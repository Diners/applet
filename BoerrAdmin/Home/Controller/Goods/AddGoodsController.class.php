...
//        $standardImageKey = 'standard_image';
        ...
        if (count($standardColor) != count($standardColor) || count($standardColor) != count($standardPrice) || count($standardColor) != count($standardCount)) {
            exit('规格参数数组长度必须相同！');
        }
